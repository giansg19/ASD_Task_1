...
void input_nilai()
{
    ...
    **/
    ...
    do
    {
        ...
        cin >> tubes;
        if (uts < 0 || uts > 100 || uas < 0 || uas > 100 || tubes < 0 || tubes > 100)
        {
            cout << "nilai yang Anda masukkan salah, silahkan coba lagi" << endl<<endl;;
        }
    }
    while (uts < 0 || uts > 100 || uas < 0 || uas > 100 || tubes < 0 || tubes > 100);
